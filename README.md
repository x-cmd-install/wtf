...
[![x-cmd/install — wtf Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/wtf.svg)](https://x-cmd.com/install/wtf)
...
- **Upstream**: <https://github.com/wtfutil/wtf>
...
- **Stars**: 17,101 · **Forks**: 862 · **Open issues**: 583 · **Contributors**: 168
...
| last60d | 2026-07-28 | 0 | 0 | 14 | 0 | 1 | 0 |
| 90d | 2026-06-28 | 1 | 30 | 53 | 0 | 4 | 29 |
| last180d | 2026-03-30 | 2 | 54 | 56 | 2 | 5 | 62 |
| 360d | 2025-10-01 | 6 | 170 | 63 | 6 | 11 | 180 |
| last720d | 2024-10-06 | 11 | 259 | 63 | 19 | 24 | 273 |
...
Install metadata for wtf lives in the [x-cmd/install](https://github.com/x-cmd/install) index — a curated YAML package list that x-cmd consumes at install time. If `wtf` is missing, out of date, or installs incorrectly, please open an issue or PR there:

- **Open an issue**: <https://github.com/x-cmd/install/issues/new>
- **Edit the package entry**: <https://github.com/x-cmd/install/edit/main/wtf.yml> (or whichever path the index uses)

The data on this page (card / loc / scorecard / release) is auto-collected by [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) and is regenerated daily. Improvements to *install behaviour* (which version gets installed, platform-specific quirks, dependencies) belong upstream in the index.

_Snapshot: `data/card/260926.yml` · 2026-09-26T05:48:33Z._
